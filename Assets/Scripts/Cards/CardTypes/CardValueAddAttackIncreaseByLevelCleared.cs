...
public class CardValueAddAttackIncreaseByLevelCleared : CardMaster
{
    ...
    public override void OnCardLevelCleared()
    {
        ...
        attackToAdd += incrementAfterLevelCleared;
        attackToAddDefault += incrementAfterLevelCleared;
        // Update the card description to reflect the new attack value
        Debug.Log($"CardValueAddAttackIncreaseByLevelCleared: Level cleared, new attack to add: {attackToAdd}");
    }
