...
public class CardActionAncientTablet : CardMaster, ICardAction
{
    ...
    {
        return GameSettings.AddIcon(string.Format(card_description, probability, amount, healthModifier, health * healthModifier, damageModifier, damage * damageModifier, health));
    }
}
