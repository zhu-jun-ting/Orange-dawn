...
public class CardGunSpiky : CardMaster
{
    ...
    public override string GetDescription()
    {
        if (current_gun != null)
        {
            return GameSettings.AddIcon(String.Format(card_description, (int)damage, probability));
        }
        return "";
    }
    ...
    public void HandleOnApplyValuesToGuns()
    {
        ...
        current_gun.speed += (int)damage;
        current_gun.critChance += probability / 100f;
